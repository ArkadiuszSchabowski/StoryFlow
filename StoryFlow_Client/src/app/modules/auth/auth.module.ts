...
import { TextSelectionComponent } from 'src/app/components/auth/text-selection/text-selection.component';
...
@NgModule({
  ...
  imports: [CommonModule, MaterialModule, FormsModule, ReactiveFormsModule, LottieModule.forRoot({ player: playerFactory }),],
  exports: [
    QuizCreateComponent,
    ProfileComponent,
    StoryCreateComponent,
